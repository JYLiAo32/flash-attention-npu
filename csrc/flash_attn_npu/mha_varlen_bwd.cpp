...
public:
    ...
    struct Params {
        ...
        Params(
            ...
            GM_ADDR dq_, GM_ADDR dk_, GM_ADDR dv_, GM_ADDR alibiSlopes_, GM_ADDR workspace_, GM_ADDR tiling_data_, GM_ADDR ptrDump_
            ...
            dq(dq_), dk(dk_), dv(dv_), alibiSlopes(alibiSlopes_), workspace(workspace_), tiling_data(tiling_data_), ptrDump(ptrDump_)
        {
        }    
    };
    ...
    void operator()(Params const &params)
    {
        ...
        EpilogueFAGOp epilogueFagOp(resource, &pipeVec, params.row_lse,
            params.atten_mask, actucal_seq_q_addr, actucal_seq_k_addr, params.alibiSlopes, params.workspace, batch, params.tiling_data);
...
void FAGVarlenOpt(uint64_t fftsAddr,
        ...
        GM_ADDR dq, GM_ADDR dk, GM_ADDR dv, GM_ADDR alibiSlopes,
        GM_ADDR workspace, GM_ADDR tiling_data, GM_ADDR ptrDump)
{
    ...
    using EpilogueAtlasA2FAGOp = Catlass::Epilogue::EpilogueAtlasA2FAGOp<HAS_ALIBI>;
    ...
    typename FAGKernel::Params params{
        ...
        dq, dk, dv, alibiSlopes, workspace, tiling_data, ptrDump};
