...
// Launch one FAGGeneral specialization. IS_CAUSAL / IS_DTM / IS_ALIBI map to the kernel's
// IS_ATTEN_MASK / IS_DTM / HAS_ALIBI template params; ALN selects DTemplateType::AlignedNNN.
// Argument order is identical to LaunchFAGGeneralKernel in fag_general_launch.hpp.
#define GEN_LAUNCH(ALN, IS_CAUSAL, IS_DTM, IS_ALIBI)                                       \
    ::FAGGeneral<DTemplateType::ALN, DType, kInputLayout, IS_CAUSAL, 0, IS_DTM, IS_ALIBI>  \
